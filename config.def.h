...
#if AUTOSTART_PATCH
static const char autostartblocksh[]     = "autostart-blocking.sh";
...
static char selfloatcolor[]              = "#ff5555";
...
static char titleselbordercolor[]        = "#282a36";
static char titleselfloatcolor[]         = "#282a36";
...
static const char *layoutmenu_cmd = "~/Programs/dwm-flexipatch/layoutmenu.sh";
#endif

#if COOL_AUTOSTART_PATCH
static const char *const autostart[] = {
  "~/scripts/autostart.sh", NULL,
};
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_o,          spawn,                  {.v = roficmd       } },
...
static const Command commands[] = {
  ...
  { {ControlMask, 0, 0, 0},                     {XK_o, XK_b, 0, 0},                             spawn,           {.v = browsercmd    } },
  { {ControlMask, 0, 0, 0},                     {XK_o, XK_l, 0, 0},                             spawn,           {.v = screenlockcmd } },
  { {ControlMask, 0, 0, 0},                     {XK_o, XK_d, 0, 0},                             spawn,           {.v = discordcmd    } },
  { {ControlMask, 0, 0, 0},                     {XK_o, XK_e, 0, 0},                             spawn,           {.v = emacscmd      } },
